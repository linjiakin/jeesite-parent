...
//import com.fsnip.jg.modules.act.service.ActTaskService;
//import com.fsnip.jg.modules.act.utils.ActUtils;
import com.fsnip.jg.modules.oa.dao.TestAuditDao;
import com.fsnip.jg.modules.oa.entity.TestAudit;
import com.fsnip.jg.modules.oa.service.testaudit.ITestAuditService;
...
public class TestAuditService extends CrudService<TestAuditDao, TestAudit> implements ITestAuditService{
...
//		actTaskService.jumpTask(testAudit.getAct().getProcInsId(), testAudit.getAct().getTaskId(), "audit2", vars);
	...
	public Page<TestAudit> find(Page<TestAudit> page, TestAudit testAudit) {
		return null;
	}

	public void delete(TestAudit entity, Boolean isRe) {
