...
import com.fsnip.jg.common.utils.excel.ExportExcel;
import com.fsnip.jg.common.utils.excel.ImportExcel;
...
//			user.setPassword(SystemService2.entryptPassword(user.getNewPassword()));
		}
...
//						user.setPassword(SystemService2.entryptPassword("123456"));
...
//			if (SystemService2.validatePassword(oldPassword, user.getPassword())){
